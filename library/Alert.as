//Nguyen Tuan Viet
//Class written for debugging purpose and solely to inform developers and evaluators in development state 
package library {
	//
	...
	public class Alert {
		...
		*/
		...
		public static function show(Text:* = "Made by Viet", ALERTOPTIONS:Object = null):void {
			if (stage == null) {
